...
module r_vm 'modules/vm/create_vm.bicep' = {
  ...
  params: {
    ...
    lb_name: r_lb.outputs.lb_name
    lb_back_end_pool_name: r_lb.outputs.lb_back_end_pool_name
    lb_back_end_pool_name_outbound: r_lb.outputs.lb_back_end_pool_name_outbound
...
module r_lb 'modules/vm/create_load_balancer.bicep' = {
  name: '${lbParams.lbNamePrefix}_${deploymentParams.global_uniqueness}_lb'
  params: {
    deploymentParams:deploymentParams
    lbParams: lbParams
    tags: tags

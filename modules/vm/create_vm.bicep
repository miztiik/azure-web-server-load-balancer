...
param  lb_name string
param  lb_back_end_pool_name string
param  lb_back_end_pool_name_outbound string
...
// Reference existing load balancer
resource r_lb 'Microsoft.Network/loadBalancers@2021-02-01' existing = {
  name: lb_name
}
/*
